...
root=Tk()
root.title("Sasikumar Calculator")
...
Button(root,text="C",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#40E0D0",command=lambda:clear()).place(x=10,y=100)
...
Button(root,text="=",width=5,height=3,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#fe9037",command=lambda:Calculation()).place(x=430,y=400)
